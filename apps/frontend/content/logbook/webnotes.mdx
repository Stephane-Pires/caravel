...
<ImageMdx
  src="/logbook/webnotes/callstack.jpg"
  alt="Illustrative showing the Javascript callstack, with a stack of function calls and the current executing function at the top of the stack."
/>
...
<ImageMdx
  src="/logbook/webnotes/css-phases.jpg"
  alt="Illustrative image showing the different phases of CSS rendering in a browser, including parsing, style calculation, layout, and painting."
/>
...
<ImageMdx
  src="/logbook/webnotes/event-propagation.jpg"
  alt="Illustrative image showing the DOM event propagation phases, including capturing, target, and bubbling phases."
/>
...
<ImageMdx
  src="/logbook/webnotes/network.jpg"
  alt="Illustrative image showing the network request/response cycle, including the client, server, and the data being transferred."
/>
